...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Tharaka De Silva"
    user-mail-address "tharaka.uo@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/tharakadesilva/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/tharakadesilva/bin" "/profile/bin" "/Users/tharakadesilva/.npm-packages/bin" "/Users/tharakadesilva/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
